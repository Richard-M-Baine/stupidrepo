                ...
                part === 'Part One' && (
                    <div className='createGroupPartOne'>
                        ...
                        <div className='createGroupPartOneFlavorText'>
                            ...
                            <p className='cfponeParagraph'>This does not have to be your address.  Feel free to select your location (like you signed up with) (add link) if your more comfortable. If you don't feel comfortable listing your address this is also recommended. You can always update the form, later on, or send the address via message once someone offers help.</p>
                            <p className='cfponeParagraph'>For requests that require transportation we suggest that the pickup location be the address of choice.  You can explain where you need to go in the about section later on. Also for safety purposes we request any minors be in the accompaniment of a legal guardian.  Preferably leave them at home.  To help with searching please enter <a target="_blank" rel="noopener noreferrer" className='stateabbreviationlink' href='https://www.faa.gov/air_traffic/publications/atpubs/cnt_html/appendix_a.html'>the appropriate state abbreviation.</a></p>
                            <p className='cfponeParagraph'>Once you communicate with the person who is offering help you can give them more exact details later on.  If you are not happy with where the api puts the marker you can always fine tune it later on.  For reasons of privacy we did not activate the full tracking features that google maps offers on this site itself.</p>
                        </div>
